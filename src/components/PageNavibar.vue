  ...
  >
    <div class="container mx-auto px-6 py-4">
      <div class="flex items-center justify-between">
        ...
        >
          <span
            class="text-2xl font-bold tracking-wider bg-gradient-to-r from-rose-400 via-purple-400 to-indigo-400 bg-clip-text text-transparent hover:from-indigo-400 hover:via-purple-400 hover:to-rose-400 transition-all duration-500 animate-gradient"
            >李睿軒 Jui-Hsuan Lee</span
          >
        </router-link>
        ...
        >
          <div class="w-6 h-0.5 bg-gray-300 relative">
            <div
              class="absolute w-full h-full bg-gray-300 transition-all duration-300 origin-center"
      ...
      <div
        class="lg:block transition-all duration-300 ease-in-out overflow-hidden"
        :class="[
          isMenuOpen
      ...
      >
        <div
          class="flex flex-col lg:flex-row lg:items-center lg:justify-end lg:space-x-8 mt-6 lg:mt-0"
        >
          <router-link
            v-for="(route, index) in routesStore.routes"
            :key="route.path"
