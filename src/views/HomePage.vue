...
const PROJECTS = ['個人作品集網站', '電商管理系統', '社群媒體應用']
</script>
...
<template>
  <main class="bg-gradient-to-b from-slate-900 to-slate-800 mt-16 pt-8 min-h-[calc(100vh-64px)]">
    ...
    >
      ...
      <!-- 技能區塊 -->
      <div
        class="bg-slate-800/90 p-10 rounded-xl shadow-lg shadow-violet-500/20 hover:shadow-xl hover:shadow-violet-500/30 transition-all duration-300 animate-fadeIn backdrop-blur-sm"
